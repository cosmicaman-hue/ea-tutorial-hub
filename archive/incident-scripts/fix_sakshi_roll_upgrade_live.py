"""
Fix Sakshi's roll upgrade in LIVE database: Replace EA24C06 with EA24D32 in monthly rosters.
...
Run from project root: python scripts/fix_sakshi_roll_upgrade_live.py
"""
...
# Backup first
backup_path = LIVE_PATH.replace('.json', f'.bak_sakshi_roll_fix_{datetime.now().strftime("%Y%m%d_%H%M%S")}.json')
