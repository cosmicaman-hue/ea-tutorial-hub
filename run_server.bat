...
REM Auto-forward every Master Update to the Render cloud server.
REM Change this URL if your Render service name differs.
if not defined SYNC_PEERS set "SYNC_PEERS=https://ea-tutorial-hub.onrender.com"
